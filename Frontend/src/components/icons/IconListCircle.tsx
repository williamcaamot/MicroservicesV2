// icon:list-circle | Ionicons https://ionicons.com/ | Ionic Framework
import * as React from "react";
import {iconProps} from "./IconAddressCard";

function IconListCircle({color = "currentColor", height = "1em", width = "1em"}: iconProps) {
    return (
        <svg
            viewBox="0 0 512 512"
            fill={color}
